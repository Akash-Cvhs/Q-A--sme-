...
#             primary_name = primary_insurance.get("insurance_company_name", "").strip()
...
#             secondary_name = secondary_insurance.get("insurance_company_name", "").strip()
...
#         # 3. Patient Consent - ✅ PASS-THROUGH (preserves Step 5 updates)
#         if "Patient_Consent" in information:
#             ordered["Patient_Consent"] = information["Patient_Consent"]
        
#         # 4. HCP Consent
#         if "HCP_Consent" in information:
#             ordered["HCP_Consent"] = information["HCP_Consent"]
