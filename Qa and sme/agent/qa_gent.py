...
# # ============================================================
# # ENHANCED ADDRESS VALIDATION WITH CROSS-FIELD FUZZY LOGIC
# # ============================================================
...
# #     """
# #     GCP-backed address validation.
# #     Output schema preserved for SME compatibility.
# #     """
...
# #         if comp_type in component_map and level != "CONFIRMED":
# #             field_name, submitted = component_map[comp_type]
# #             expected = normalized.get(
# #                 {
# #                     "street": "addressLines",
# #                     "city": "locality",
...
# #                 "submitted": submitted,
# #                 "expected": expected,
# #                 "reason": "Corrected by Google Address Validation",
# #             }

# #             confidence -= 15

# #     ground_truth = {
# #         "street": normalized.get("addressLines", [None])[0],
# #         "city": normalized.get("locality"),
# #         "state": normalized.get("administrativeArea"),
# #         "zip_code": normalized.get("postalCode"),
# #     }

# #     address_valid = verdict.get("addressComplete", False)

# #     if not address_valid:
# #         manual_review = verdict.get("hasUnconfirmedComponents", False)
# #         confidence = min(confidence, 70)

# #     confidence = max(0, min(confidence, 100))

# #     return {
# #         "address_valid": address_valid and not incorrect,
...
#         submitted_address = {
#             "street": prescription.get("address", "").strip(),
#             "city": prescription.get("city", "").strip(),
#             "state": prescription.get("state", "").strip(),
#             "zip_code": prescription.get("postal_code", "").strip()
#         }
...
#         # ------------------------------
#         npi = prescription.get("npi_number", "").strip()
#         if not npi:
#             return {
#                 "address_valid": False,
#                 "incorrect_fields": {},
...
#         primary_name = primary_ins.get("insurance_company_name", "").strip()
#         if primary_name:
...
#         secondary_name = secondary_ins.get("insurance_company_name", "").strip()
#         if secondary_name:
...
#         npi = presc.get("npi_number", "").strip()
